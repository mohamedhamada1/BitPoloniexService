...
public class RXPostRequestCreator {
    ...
    public RXPostRequestCreator addHeader(String key,String value) {
        postRequestBuilder.addHeaders(key,value);
        return this;
    ...
    public RXPostRequestCreator addUrlEncodeFormBodyParameter(String key, String value) {
        postRequestBuilder.addUrlEncodeFormBodyParameter(key, value);
        return this;
    }

    public RXPostRequestCreator addUrlEncodeFormBodyParameter(Object object) {
        postRequestBuilder.addUrlEncodeFormBodyParameter(object);
        return this;
    }

    public RXPostRequestCreator addUrlEncodeFormBodyParameter(HashMap<String, String> map) {
        postRequestBuilder.addUrlEncodeFormBodyParameter(map);
        return this;
    }
